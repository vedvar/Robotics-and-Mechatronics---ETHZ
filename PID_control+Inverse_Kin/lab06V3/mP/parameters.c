...
int load_parameters()
{
  ...
  //// Gurten //////
  //////////////////
  bbs.calibration_image_scale = 3.51; //3.74
  bbs.focal_length = 418; //495
  bbs.radial_distortion_coeff[0] = -0.2141; //-0.3298
  bbs.radial_distortion_coeff[1] = 1.09; //0.1583  0.0403 used old value because it works better
  bbs.distortion_center[0] = 556; //595
  bbs.distortion_center[1] = 327; //429

  // Adjust these if lens is removed and reinserted
  bbs.cam_offset[0] = 4; //4 5
  bbs.cam_offset[1] = 20; //7 15
  bbs.cam_offset[2] = 28.1; //28.1
